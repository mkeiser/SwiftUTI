...
public extension UTI {
 ...
 static let objectiveCSource		= UTI(rawValue: kUTTypeObjectiveCSource as String)
	@available( OSX 10.11, iOS 9.0, * ) static let swiftSource		= UTI(rawValue: kUTTypeSwiftSource as String)
 ...
 static let scalableVectorGraphics		= UTI(rawValue: kUTTypeScalableVectorGraphics as String)
	@available( OSX 10.12, iOS 9.1, * ) static let livePhoto		= UTI(rawValue: kUTTypeLivePhoto as String)
